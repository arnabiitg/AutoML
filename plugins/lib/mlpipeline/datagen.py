...
class datagen:
    ...
    def train_test_gen_temp():
        ...
        # train test split
        x_train_temp, x_test_temp, y_train_temp, y_test_temp = train_test_split(data, data[:,0],train_size= float(params["train_size"]), shuffle = False)
    ...
    def train_test_gen_humid():
        ...
        # train test split
        x_train_humid, x_test_humid, y_train_humid, y_test_humid = train_test_split(data, data[:,1],train_size= float(params["train_size"]), shuffle = False)
    ...
    def train_test_gen_speed():
        ...
        # train test split
        x_train_speed, x_test_speed, y_train_speed, y_test_speed = train_test_split(data, data[:,1],train_size= float(params["train_size"]), shuffle = False)
